...
const LoginForm = () => {
  ...
  return (
    <div
      ...
      className="w-full sm:w-[360px] bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col gap-4"
    >
      ...
      <form onSubmit={onLoginSubmit} className="flex flex-col gap-4">
        <TextField name="email" disabled={isPending} aria-label="Email Address" aria-required="true" />
        <TextField type="password" name="password" disabled={isPending} aria-label="Password" aria-required="true" />
