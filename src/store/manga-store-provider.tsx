...
export const MangaStoreContext = createContext<MangaStoreApi | undefined>(
  undefined,
)
...
export const MangaStoreProvider = ({
  children,
}: MangaStoreProviderProps) => {
  ...
  return (
    <MangaStoreContext.Provider value={storeRef.current}>
      {children}
    </MangaStoreContext.Provider>
  )
}

export const useMangaStore = <T,>(
  selector: (store: MangaStore) => T,
): T => {
