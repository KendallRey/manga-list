...
// #region setOnChange
export const setOnChange = <T extends Record<string, unknown>>(set: SetFnType<T>, e: RCE<HTMLInputElement | HTMLTextAreaElement>) => {
...
// #region resetErrors
export const resetErrors = <T extends Record<string, unknown>>(set: SetFnType<T>, data?: Partial<Record<string, unknown>>) => {
  return set((state: FormStoreType<T>) => {
